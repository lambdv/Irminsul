...
export default function APISettings() {
  ...
  const handleDataProviderChange = async (
    value: "irminsul" | "genshin-data" | "custom"
  ) => {
        ...
        {dataProvider === "custom" && (
          <>
            <p className="text-sm text-gray-500 mt-2">
              If custom api breaks the site, clear the cookie and refresh the
              page to reset to the default endpoints.
            </p>
            <p className="text-sm text-gray-500 mt-2">
              Custom api must follow our applications{" "}
              <a
                href="https://github.com/lambdv/Irminsul/tree/main/apps/Irminsul/src/types"
                target="_blank"
                rel="noreferrer"
