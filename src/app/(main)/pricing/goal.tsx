...
export default function DonationGoal(props: {
  ...
  useEffect(() => {
    const fetchPayments = async () => {
      ...
      const total = paymentsThisMonth.reduce(
    ...
    <div>
      ...
      <div
        style={{
          borderRadius: "100px",
          overflow: "hidden",
          backgroundColor: "var(--light-elevated-color)",
        }}
      >
        <div
          style={{
            ...
            background:
              progressPercentage >= 100 ? "green" : "var(--primary-color)",
      ...
      <p>
        ${totalDonations.toFixed(2)} of ${props.goalAmount} raised
      </p>
    </div>
  )
}
