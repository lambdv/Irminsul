...
import { queryGCSIMDatabase } from "@/app/(main)/seelie/toolHelpers";
...
export const getInformationTool = tool(
    ...
    {
        name: "getInformation",
        description: "Search the web for real-time information about Genshin Impact. Use this tool ONCE per question to find relevant information. After receiving results, synthesize them into your answer.",
        schema: z.object({
...
export const queryGCSIMDatabaseTool = tool(
    ...
    },
    {
        ...
        description: "Query GC SIM Team Calculation Database for team DPS comparisons. Use to answer questions about best teams, damage calculations, and character rankings.",
        schema: z.object({
            characters: z.array(z.string()).optional().describe("Character names to include in team search"),
            excludeCharacters: z.array(z.string()).optional().describe("Character names to exclude"),
...
export const getInformationFromKnowledgeBaseTool = tool(
    ...
    },
    {
        ...
        description: "Get information from the knowledge base to answer Genshin Impact questions",
        schema: z.object({
